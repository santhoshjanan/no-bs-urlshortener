...
<head>
    ...
    <script type="text/javascript">
        ...
        })(window, document, "clarity", "script", "pwm9zju7wt");
    </script>
</head>
<body class="bg-light">
<div class="container mt-5">
    ...
    @if (isset($shortened_url))
        <div class="mt-4">
            <p class="fw-bold">Shortened URL: <span  data-bs-toggle="tooltip" title="Since there is no session saved, the shortened URL will be shown only once. Once you refresh the page, you cannot retrieve it. But you can create a new one. Done forget to copy it! 🔥">
    ...
    @if ($errors->any())
        <div class="mt-3 pt-3 alert alert-danger">
            <ul>
...
<div class="footer">
  ...
  <path d="M8.235 1.559a.5.5 0 0 0-.47 0l-7.5 4a.5.5 0 0 0 0 .882L3.188 8 .264 9.559a.5.5 0 0 0 0 .882l7.5 4a.5.5 0 0 0 .47 0l7.5-4a.5.5 0 0 0 0-.882L12.813 8l2.922-1.559a.5.5 0 0 0 0-.882zM8 9.433 1.562 6 8 2.567 14.438 6z"/>
        ...
        &nbsp;
        <span data-bs-toggle="tooltip" title="How: I use this app a lot. So sharing with the world. I dont lose anything 🤷🏼‍♂️"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-patch-question-fill" viewBox="0 0 16 16">
  <path d="M5.933.87a2.89 2.89 0 0 1 4.134 0l.622.638.89-.011a2.89 2.89 0 0 1 2.924 2.924l-.01.89.636.622a2.89 2.89 0 0 1 0 4.134l-.637.622.011.89a2.89 2.89 0 0 1-2.924 2.924l-.89-.01-.622.636a2.89 2.89 0 0 1-4.134 0l-.622-.637-.89.011a2.89 2.89 0 0 1-2.924-2.924l.01-.89-.636-.622a2.89 2.89 0 0 1 0-4.134l.637-.622-.011-.89a2.89 2.89 0 0 1 2.924-2.924l.89.01zM7.002 11a1 1 0 1 0 2 0 1 1 0 0 0-2 0m1.602-2.027c.04-.534.198-.815.846-1.26.674-.475 1.05-1.09 1.05-1.986 0-1.325-.92-2.227-2.262-2.227-1.02 0-1.792.492-2.1 1.29A1.7 1.7 0 0 0 6 5.48c0 .393.203.64.545.64.272 0 .455-.147.564-.51.158-.592.525-.915 1.074-.915.61 0 1.03.446 1.03 1.084 0 .563-.208.885-.822 1.325-.619.433-.926.914-.926 1.64v.111c0 .428.208.745.585.745.336 0 .504-.24.554-.627"/>
        ...
        &nbsp;
        <span data-bs-toggle="tooltip" data-bs-html="true" title="Privacy: I collect basic statistics of page. None of the personal identification data nor user input are recorded."><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-check" viewBox="0 0 16 16">
  ...
  <path d="M10.854 5.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0"/>
        ...
        <span data-bs-toggle="tooltip" title="Feedback: Please click on this icon to send me your feedback and/or feature request. I will be happy to hear from you!">
            <a href="mailto:viscous.buys4y@icloud.com">
        ...
        <span data-bs-toggle="tooltip" title="Easiest way to reach me is Twitter. (X is a social media app. Twitter is an emotion. Twitter daaw!!💪💪💪)">
            <a href="//x.com/santhoshj" target="_blank">
