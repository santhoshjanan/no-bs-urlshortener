    ...
    <footer class="vb-footer">
        <div class="vb-footer-content">
            ...
            <div class="vb-footer-right">
                ...
                <a href="{{ route('privacy') }}" class="vb-footer-icon" title="Privacy: I collect basic statistics of page. None of the personal identification data nor user input are recorded.">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                ...
                <a href="https://x.com/santhoshj" target="_blank" rel="noopener noreferrer" class="vb-footer-icon" title="Easiest way to reach me is Twitter. (X is a social media app. Twitter is an emotion. Twitter daaw!!)">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                    </svg>
                </a>
                <a href="https://github.com/santhoshjanan/no-bs-urlshortener" target="_blank" rel="noopener noreferrer" class="vb-footer-icon" title="View source code on GitHub">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
